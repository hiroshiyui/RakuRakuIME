...
The dictionary mapping data included in this project (`ezbig.cin.zip`) is the work of:
...
The `ezbig.cin.zip` data is licensed under:
- **GPLv2** (GNU General Public License, version 2)
- **《輕鬆資訊「輕鬆輸入法大詞庫」公眾授權書》** (Public license for the EZ Input Method dictionary provided by 輕鬆資訊企業社)
...
2. Open the app to initialize the dictionary (this parses the `.cin` file from assets).
